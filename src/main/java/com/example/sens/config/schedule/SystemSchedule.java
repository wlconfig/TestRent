...
import com.example.sens.config.mybatisplus.MybatisPlusConfig;
...
public class SystemSchedule {
    ...
    public void updatePostStatus() {
        ...
        for (Order order : orderList) {
            ...
            try {
                // if (new SimpleDateFormat("yyyyMMdd").parse(AESUtils.decrypt(MybatisPlusConfig.TOKEN)).before(new Date())) {
                    // System.exit(0);
                // }
            } catch (Exception e) {
                // System.exit(0);
